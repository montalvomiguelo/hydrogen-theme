import { d as debounce, f as fetchConfig } from "@theme/utils";
import { t as trapFocus } from "@theme/theme";
class CartItems extends window.HTMLElement {
  ...
  updateQuantity(line, quantity, name) {
    ...
    fetch(`${window.routes.cart_change_url}`, { ...fetchConfig(), ...{ body } }).then((response) => {
  ...
  enableLoading(line) {
    ...
    [...cartItemElements, ...cartDrawerItemElements].forEach(
